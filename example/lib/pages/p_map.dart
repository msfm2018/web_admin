...
class PMaps extends StatelessWidget {
  const PMaps({Key? key}) : super(key: key);
          ...
          child: SfMaps(
            layers: <MapShapeLayer>[
              MapShapeLayer(
                ...
                dataLabelSettings: MapDataLabelSettings(textStyle: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: Theme.of(context).textTheme.caption!.fontSize)),
              ),
            ],
          ),
        ),
